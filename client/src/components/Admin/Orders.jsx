  ...
  const columns = [
    {
      ...
      headerName: 'Table No.',
      align: 'center',
      valueGetter: (params) => params.row.user === undefined ? '' : params.row.user.table,
    },
    {
      field: 'name',
      headerName: 'Name',
      width: 150,
      align: 'left',
      valueGetter: (params) => params.row.user === undefined ? '' : params.row.user.name,
    },
    {
      field: 'mobile',
      type: 'number',
      ...
      align: 'right',
      sortable: false,
      valueGetter: (params) => params.row.user === undefined ? '' : params.row.user.mobile,
      width: 120,
    },
    {
      field: 'items',
