...
const userInit = {
  ...
  function validateForm() {
    return user.firstname.length > 2 && user.surname.length > 2 && user.mobile.length == 10;
  }
          ...
          <div className="d-block justify-content-between text-center" >
            ...
            {cart != null && cart.length > 0 ?
              <>
                ...
                <button className="btn btn-danger m-1" onClick={() => { clearCart(); setShowForm(false); }}>Clear Cart</button></> : ''}
          </div>
        </div>
